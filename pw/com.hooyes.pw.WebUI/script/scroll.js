...
var playList = {
    ...
    //图片数组
    imgArray: ["/content/images/home/1.jpg", "/content/images/home/2.jpg", "/content/images/home/3.jpg", "/content/images/home/4.jpg",  "/content/images/home/5.jpg" ],
    //imgArray:sImgArray,
    //链接数组
    linkArray: ["product_001.html", "product_002.html", "product_003.html", "product_004.html", "product_005.html"],
    //链接ID
    linkArrayID: ["m2", "mainWindowLinkOf6510", "m", "mainWindowLinkOf2041new", "mainWindowLinkOf5510"],
    //商城链接数组
    shoplinkArray: ["product_001.html", "product_002.html", "product_003.html", "product_004.html", "product_005.html"],
    //linkArray:allLinkArray,
    //--说明文字
    introArray: ["TL-WDR5600", "TL-WDR6510", "TL-TR961 2500移动版", "TL-WR2041+", "TL-WDR5510"],
...
function playOnce() {
    ...
    {*/
    $('#' + playList.displayDiv + ' img').eq(playList.focusImgIndex).animate({ opacity: 1 }, playList.animateTime, function () {
        if 
...
(playList.mouseFlage) { playList.stop(); }
    ...
    {*/
    $('#' + playList.displayDiv + ' img').eq(playList.blurImgIndex).animate({ opacity: 0 }, playList.animateTime, function () {
        if 
