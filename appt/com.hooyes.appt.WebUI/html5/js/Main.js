...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">Hooyes!</span><br /><br /><span style="font-size:15px;"><strong>www.wehealthsystem.com</strong><br /><br />1. 健康管理.<br />2.健康管理<br />3. 健康管理.<br />4. 健康管理.<br />5. 健康管理!</span>';
